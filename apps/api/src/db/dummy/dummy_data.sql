...
VALUES
-- cattleId=1 (自動採番)
(1, 1001, 1234, 'たろう',   'CALF',   '2023-01-01', 1,   12,  30,  'オス', '110',   70, '黒毛和種', '妊娠中',      '生産者A', '牛舎A', 'AAAAAA', '健康状態良好'),
-- cattleId=2
(1, 1002, 5678, 'ハナコ', 'FIRST_CALVED',   '2020-06-10', 3,   36,  100, 'メス', '120', 85, '黒毛和種', '健康',      '生産者A', '牛舎A', 'BABCBB', '非常におとなしい性格で、健康良好'),
-- cattleId=3
(2, 2001, 9012, 'じろう',   'FATTENING', '2022-07-20', 1,   14,  45,  'メス', '130',   78, '黒毛和種',   '治療中', '生産者B', '牛舎B', 'BABCBB', '成長が早く、今後の期待大'),
-- cattleId=4
(2, 2002, 3456, 'マルコ', 'GROWING', '2021-05-15', 2,   24,  70,  'オス', '140', 90, '黒毛和種',   '休息中',      '生産者B', '牛舎B', 'AAAAAA', '生産後の休息中。元気な状態を維持');
