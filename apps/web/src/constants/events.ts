export const eventTypeColors: Record<string, string> = {
	...
	EXPECTED_ESTRUS: "bg-pink-50 text-pink-600 border-pink-200",
	INSEMINATION: "bg-blue-100 text-blue-800 border-blue-300",
	PREGNANCY_CHECK: "bg-teal-100 text-teal-800 border-teal-300",
	EXPECTED_CALVING: "bg-blue-100 text-blue-800 border-blue-300",
	...
	DEATH: "bg-red-100 text-red-800 border-red-300",
