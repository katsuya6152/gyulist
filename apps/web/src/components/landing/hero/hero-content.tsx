				...
				<div className="flex flex-col gap-3 max-w-xl mx-auto md:mx-0">
					...
					<div className="flex flex-col sm:flex-row gap-3 sm:items-center justify-center md:justify-start">
						<div className="flex flex-col sm:flex-row gap-3">
							...
							<Link
								href="/register"
								className="inline-flex justify-center items-center border border-primary text-primary px-6 py-3 rounded-full font-semibold hover:opacity-95 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400 transform hover:scale-105 transition-all duration-300 hover:shadow-lg"
