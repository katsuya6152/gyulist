				...
				<div className={cn("flex flex-col gap-6")}>
					...
					>
						<CardHeader className="text-center">
							...
							<CardDescription>
								登録したメールアドレスとパスワードを入力するか、Googleアカウントでログインしてください。
							</CardDescription>
						</CardHeader>
						<CardContent>
							<form action={formAction} className="flex flex-col gap-6">
								...
								<div>
									...
									>
										...
										{isGoogleLoading ? "Googleに接続中..." : "Googleでログイン"}
									</Button>
								</div>

								<Button
									variant="outline"
									className="w-full transition-all duration-200 hover:scale-105 bg-blue-50 hover:bg-blue-100 border-blue-200 text-blue-700 hover:text-blue-800"
