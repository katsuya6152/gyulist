...
export function CattleEditPresentation({
	...
	const [form, fields] = useForm({
		...
		defaultValue: {
			...
			// 		cattle.breedingSummary?.totalInseminationCount?.toString() || "",
			// 	averageDaysOpen:
			// 		cattle.breedingSummary?.averageDaysOpen?.toString() || "",
			// 	averagePregnancyPeriod:
			// 		cattle.breedingSummary?.averagePregnancyPeriod?.toString() || "",
			// 	averageCalvingInterval:
			// 		cattle.breedingSummary?.averageCalvingInterval?.toString() || "",
			// 	difficultBirthCount:
			// 		cattle.breedingSummary?.difficultBirthCount?.toString() || "",
			// 	pregnancyHeadCount:
			// 		cattle.breedingSummary?.pregnancyHeadCount?.toString() || "",
			// 	pregnancySuccessRate:
			// 		cattle.breedingSummary?.pregnancySuccessRate?.toString() || "",
			// },
		},
	});
