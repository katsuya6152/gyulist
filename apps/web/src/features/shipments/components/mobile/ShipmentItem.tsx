...
export const ShipmentItem = memo(({ shipment, index }: ShipmentItemProps) => {
						...
						<div className="pt-3 space-y-3">
							...
							<div className="grid grid-cols-2 gap-3 text-xs">
								...
								<div>
									...
									<div className="font-medium">{shipment.birthDate || "-"}</div>
								</div>
								<div>
